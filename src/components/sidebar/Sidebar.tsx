...
export default function Sidebar({ mobile = false, onClose }: SidebarProps) {
  ...
  const { chats, models, createNewChat, activeChatId, setActiveChat } = useChatStore();
  ...
  return (
    <div className="flex h-full w-72 flex-col border-r border-divider bg-content1">
      ...
      <div className="flex items-center justify-between px-4 pb-2">
        <Button color="primary" startContent={<Icon icon="lucide:plus" />} onPress={handleNewChat}>
          New Chat
        </Button>
      ...
      <div className="flex-1 overflow-y-auto p-2">
        ...
        {groupedChats.pinned.length > 0 && (
          <div className="mb-4">
            <div className="mb-1 px-2 text-xs font-medium text-default-500">PINNED</div>
        ...
        {groupedChats.today.length > 0 && (
          <div className="mb-4">
            <div className="mb-1 px-2 text-xs font-medium text-default-500">TODAY</div>
        ...
        {groupedChats.yesterday.length > 0 && (
          <div className="mb-4">
            <div className="mb-1 px-2 text-xs font-medium text-default-500">YESTERDAY</div>
        ...
        {groupedChats.thisWeek.length > 0 && (
          <div className="mb-4">
            <div className="mb-1 px-2 text-xs font-medium text-default-500">LAST 7 DAYS</div>
        ...
        {groupedChats.thisMonth.length > 0 && (
          <div className="mb-4">
            <div className="mb-1 px-2 text-xs font-medium text-default-500">THIS MONTH</div>
        ...
        {groupedChats.older.length > 0 && (
          <div className="mb-4">
            <div className="mb-1 px-2 text-xs font-medium text-default-500">LONG TIME AGO</div>
